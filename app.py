...
def create_collection():
    ...
    if request.method == 'POST':
        ...
        get_or_create_collection(current_user=current_user, name=form.name.data, gif_list=gif_objects)
...
def collections():
    ...
    collection = PersonalGifCollection.query.filter_by(
